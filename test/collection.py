...
@test(True, create_collection, clear_collection)
def insert_single(collection):
    result = collection.insert({'a': 1}, True)
    return result is not None

@test(1, create_collection, clear_collection)
