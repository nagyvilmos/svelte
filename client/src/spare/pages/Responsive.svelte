...
<div style="overflow:auto">
  ...
  <div class="main">
    <h2>The Walk</h2>
    <p>
      The walk from Monterosso to Riomaggiore will take you approximately two
      hours, give or take an hour depending on the weather conditions and your
      physical shape.
    </p>
    <!-- svelte-ignore a11y-img-redundant-alt -->
    <img alt="A picture of terre" src="https://www.w3schools.com/html/img_5terre.jpg" style="width:100%"/>
  </div>

  <div class="right">
    <h2>What?</h2>
    <p>
      Cinque Terre comprises five villages: Monterosso, Vernazza, Corniglia,
